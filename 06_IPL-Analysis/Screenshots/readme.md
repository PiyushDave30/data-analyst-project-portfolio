...
|-----------|------|---------|-------|------------|
| [Structure](ipl_notebook_structure.png) | JupyterLab | Overview | Table of Contents — all notebook sections | 156 cells |
| `top_run_scorers.png) | Seaborn | Batting | Top 10 Run Scorers bar chart | V Kohli — 8,671 runs |
| `top_six_hitters.png` | Seaborn | Batting | Top 10 Six Hitters bar chart | CH Gayle — 359 sixes |
| `top_four_hitters.png` | Seaborn | Batting | Top 10 Four Hitters bar chart | V Kohli — 774 fours |
| `most_balls_faced.png` | Seaborn | Batting | Most Balls Faced bar chart | V Kohli — 6,702 balls |
| `top_wicket_takers.png` | Seaborn | Bowling | Top 10 Wicket Takers bar chart | YS Chahal — 229 wickets |
| `most_dot_balls.png` | Seaborn | Bowling | Most Dot Balls bar chart | B Kumar — 1,748 dots |
| `most_wide_balls.png` | Seaborn | Bowling | Most Wide Balls bar chart | DJ Bravo — 167 wides |
| `wins_vs_losses.png` | Matplotlib | Team | Wins vs Losses grouped bar chart | MI — 151 wins |
| `avg_run_rate_per_season.png` | Matplotlib | Season | Average Run Rate per Season line chart | Upward trend across seasons |
| `runs_per_over.png` | Matplotlib | Season | Runs per Over colour-coded bar chart | Over 17–18 highest |
